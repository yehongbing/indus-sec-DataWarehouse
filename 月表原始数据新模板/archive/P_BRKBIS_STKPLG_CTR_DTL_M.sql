...
BEGIN 
  ...
  *********************************************************************/
  ...
  SELECT 
      ...
      ,T_JG.WH_ORG_ID                                       AS        ORG_NO                     --机构编号        
      ,T_JG.CENT_BRH_NAME                                   AS        BRH                        --营业部            
      ,T_JG.SEPT_CORP_NAME                                  AS        SEPT_CORP                  --分公司              
      ,T_JG.ORG_TYPE                                        AS        SEPT_CORP_TYPE             --分公司类型        
      ...
      ,1                                                    AS        IF_LS                      --是否限售       
      ,T1.GUAR_SECU_MVAL_FINAL                              AS        STKPLG_TOTAST_FINAL        --股票质押总资产_期末                  
      ,T1.GUAR_SECU_MVAL_FINAL - T1.STKPLG_FIN_BAL_FINAL    AS        STKPLG_NET_AST_FINAL       --股票质押净资产_期末                                            
      ,T1.STKPLG_FIN_BAL_FINAL                              AS        STKPLG_BAL_FINAL           --股票质押余额_期末                  
      ,T1.GUAR_SECU_MVAL_MDA                                AS        STKPLG_TOTAST_MDA          --股票质押总资产_月日均                
      ,T1.GUAR_SECU_MVAL_MDA - T1.STKPLG_FIN_BAL_MDA        AS        STKPLG_NET_AST_MDA         --股票质押净资产_月日均                                        
      ,T1.STKPLG_FIN_BAL_MDA                                AS        STKPLG_BAL_MDA             --股票质押余额_月日均                
      ,T1.GUAR_SECU_MVAL_YDA                                AS        STKPLG_TOTAST_YDA          --股票质押总资产_年日均                
      ,T1.GUAR_SECU_MVAL_YDA - T1.STKPLG_FIN_BAL_YDA        AS        STKPLG_NET_AST_YDA         --股票质押净资产_年日均                                        
      ,T1.STKPLG_FIN_BAL_YDA                                AS        STKPLG_BAL_YDA             --股票质押余额_年日均                
  ...
  LEFT JOIN DM.T_AGT_STKPLG_AGMT T_STKPLG_AGMT
        ON T_STKPLG_AGMT.OCCUR_DT = @V_BIN_DATE
